...
public class PlayerController : MonoBehaviour
{
    ...
    // to make rigidbody work correctly and to not have object rotate.
    private void Awake()
    {
...
// to keep physics based movement in check
    ...
    // checks player input for jumping and provides debug key to kill player for testing (Key K)
    private void Update()
    {
        if (!canMove) return;
